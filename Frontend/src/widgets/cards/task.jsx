...
export function Task({ id , name , description , status }) {
  ...
  return (
    <div class=" bg-white p-6 rounded-md shadow-xl mb-6 border-2 border-gray-100 hover:border-black hover:border-2 transition-colors duration-300">
    ...
    <div
        ...
        <div className="flex items-start justify-start space-x-2 mt-3 mb-3">
          {icon}
          <Typography variant="small" className={`font-normal text-gray-600 capitalize`}>
            {status}
          </Typography>
        </div>   
